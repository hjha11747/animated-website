        ...
        <>
            ...
            <div className='section overflow-x-hidden'>
                <div className=" min-h-[85vh] w-full py-7 px-[80px] flex justify-between flex-wrap contain  max-medium:flex-col  max-sm:px-3 ">
                    <div className=" flex-shrink-0 h-[333px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line1 left mb-14  max-xl:px-5 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2  max-sm:mb-9 max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                    ...
                    <div className=" flex-shrink-0 h-[330px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line1 right mb-14  max-xl:px-8 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2 max-sm:mb-9 bg-black max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                        <div className=" elem-part1 h-full w-[50%] flex justify-between flex-col">
                    ...
                    <div className="  flex-shrink-0 h-[330px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line2 left mb-14  max-xl:px-8 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2 max-sm:mb-9 bg-black  max-medium:bg-white max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                        <div className="elem-part1 h-full w-[50%] flex justify-between flex-col">
                    ...
                    <div className=" flex-shrink-0 h-[330px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line3 left mb-14  max-xl:px-5 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2 max-sm:mb-9 max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                        <div className="elem-part1 h-full w-[50%] flex justify-between flex-col">
                    ...
                    <div className=" flex-shrink-0 h-[330px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line3 right mb-14  max-xl:px-5 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2 max-sm:mb-9 bg-black max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                        <div className="elem-part1 h-full w-[50%] flex justify-between flex-col">
                    ...
                    <div className="  flex-shrink-0 h-[330px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line4 left mb-14  max-xl:px-5 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2 max-sm:mb-9 bg-black max-medium:bg-white max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                        <div className="elem-part1 h-full w-[50%] flex justify-between flex-col">
                            <h2 className=' bg-white max-medium:bg-lime-300  w-[89%] text-[23px] font-semibold px-2 rounded-md max-lg:text-[20px]  max-sm:text-[17px]  max-small:text-[15px] max-xs:text-[13px]'>Graphics &
                                Video Editing</h2>
                            <Link to="https://www.udemy.com/course/complete-graphics-design-and-video-editing-masterclass/" target="_blank" rel="noopener noreferrer" className='text-[20px]  max-sm:text-[15px] max-xs:text-[13px] text-white max-medium:text-black'>Learn More<i className="ri-arrow-right-up-line text-[25px] max-xs:text-[17px]  pl-1"></i></Link>
                        </div>
                        <div className="elem-part2 h-full w-[50%]">
                    ...
                    <div className=" flex-shrink-0 h-[330px] w-[47%] rounded-lg shadow-lg border border-solid p-14 flex  elem line4 right mb-14  max-xl:px-5 max-medium:w-[90%] max-medium:mx-auto  max-sm:h-[230px]  max-xs:h-[200px] max-xs:py-6  max-sm:py-8  max-small:w-[100%] max-small:px-2 max-sm:mb-9 max-medium:bg-black max-sm:hover:transform max-sm:hover:scale-105 max-sm:duration-500">
                        <div className="elem-part1 h-full w-[50%] flex justify-between flex-col">
